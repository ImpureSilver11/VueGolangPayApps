...
var fileDescriptor_6e5aad0ac58a7583 = []byte{
	...
	0x80, 0x07, 0x28, 0x0e, 0x6f, 0x64, 0x8f, 0x8c, 0x55, 0xfb, 0xbf, 0x82, 0xf6, 0x2f, 0x7e, 0x75,
	0x7b, 0x76, 0x76, 0x02, 0x6b, 0x2e, 0x5e, 0x0b, 0xe9, 0xf0, 0xe1, 0x3b, 0x00, 0x00, 0xff, 0xff,
	0xdf, 0x2b, 0x57, 0x26, 0x56, 0x01, 0x00, 0x00,
}
...
type PayManagerClient interface {
	Change(ctx context.Context, in *PayRequest, opts ...grpc.CallOption) (*PayResponse, error)
}
...
func (c *payManagerClient) Change(ctx context.Context, in *PayRequest, opts ...grpc.CallOption) (*PayResponse, error) {
	out := new(PayResponse)
	err := c.cc.Invoke(ctx, "/paymentservice.PayManager/Change", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PayManagerServer interface {
	Change(context.Context, *PayRequest) (*PayResponse, error)
}
...
func _PayManager_Change_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayManagerServer).Change(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/paymentservice.PayManager/Change",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayManagerServer).Change(ctx, req.(*PayRequest))
	}
...
var _PayManager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Change",
			Handler:    _PayManager_Change_Handler,
		},
	},
